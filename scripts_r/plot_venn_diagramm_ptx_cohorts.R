...
CT
myV <-plotVenn(list("Chest Tube"=CT, "Pneumothorax"=PTX), borderWidth = 3, setColors=c('#9ED9A4', '#9BC1E2', '#F9F18B'), labelRegions = F, fontScale = 1.5, nCycles = 2000, outFile=out_file)
